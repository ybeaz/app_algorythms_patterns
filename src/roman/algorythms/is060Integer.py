...
def is060Integer(**kwargs) -> bool:
  ''' Description: Function check if num is integer
    Import: from src.roman.algorythms.isInteger import isInteger
    Run: python -m src.roman.algorythms.isInteger
  '''
  try:
...
if __name__ == "__main__":
  ...
  for kwargs in kwargsList:
    ...
    output: bool = is060Integer(**kwargs)
    num = kwargs['num']
