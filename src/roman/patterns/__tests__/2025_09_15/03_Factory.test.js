...
describe('Creational Patterns', () => {
  it('--  2022-01-29 Pattern: Factory Method Creates an instance of several derived classes', () => {
    ...
    const factoryInput = ['fulltime', 'fulltime', 'fulltime', 'parttime', 'temporary', 'temporary', 'contractor']

    const employees = factoryInput.map(employeeType => new factory(employeeType))
